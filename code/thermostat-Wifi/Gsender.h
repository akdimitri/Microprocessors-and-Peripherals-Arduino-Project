...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "ENTER_YOUR_LOGIN_INFO_IN_BASE64";          // transform your LOGIN info to Base 64
        const char* EMAILBASE64_PASSWORD = "ENTER_YOUR_LOGIN_INFO_IN_BASE64";
        const char* FROM = "SENDER_EMAIL";
